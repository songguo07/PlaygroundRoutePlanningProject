                ...
                <div class="sidebar-nav">
                  <div class="nav-header" data-toggle="collapse" data-target="#dashboard-menu"><i class="icon-dashboard"></i>娱乐设施管理</div>
                    <ul id="dashboard-menu" class="nav nav-list collapse in">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/views/department/addDep.jsp">增加娱乐设施</a></li>               
                    </ul>
...
<div class="well">
    ...
    <form id="tab" role="form" action="${pageContext.request.contextPath}/DoAdd" method="post" class="registration-form">
        <label>设备号</label>
        <input type="text" class="input-xlarge" name="d_id">
        <label>设备名称</label>
        <input type="text" class="input-xlarge" name="d_name">
        <label>设备平均评分</label>
        <input type="text" class="input-xlarge" name="d_aver_score">
        <label>设备描述</label>
        <input type="text" class="input-xlarge" name="d_des">
        <label>设备类型号</label>
        <input type="text" class="input-xlarge" name="type_id">        
