...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="container-fluid">
                ...
                <div class="sidebar-nav">
                  <div class="nav-header" data-toggle="collapse" data-target="#dashboard-menu"><i class="icon-dashboard"></i>娱乐设施管理</div>
                    <ul id="dashboard-menu" class="nav nav-list collapse in">
                   		<li><a href="${pageContext.request.contextPath}/findAll">所有娱乐设施</a></li>
                        <li class="active"><a href="${pageContext.request.contextPath}/views/department/searchDep.jsp">查询娱乐设施</a></li>
        ...
        <div class="span9">
            <h1 class="page-title">查询娱乐设施</h1>
<div class="btn-toolbar">
<form action="${pageContext.request.contextPath}/selectById">

 <input type="text"  name="d_id" placeholder="设备id..."  value="${d_id}">
  <!-- - <a href="${pageContext.request.contextPath}/selectById"><button class="btn" type="submit">按设备id查询</button></a> --> 
 
 <input type="text" name="d_name" placeholder="设备名称..." value="${d_name}" >
     <!-- - <a href="${pageContext.request.contextPath}/selectById"><button class="btn" type="submit">按设备名查询</button></a>--> 
<li > 
    <input type="submit" value="查询设备">
</li>
  <div class="btn-group">
  </div>
</form>
      ...
      <tbody>
         <c:forEach items="${department}" var="department">
            <tr>                
                ...
                <td>
                    <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}//alter1?d_id=${department.d_id }">修改</a>&nbsp;
                    <a class="btn btn-default btn-sm" href="javascript:;" onclick="userDel(${department.d_id})">删除</a>
                </td>
            </tr>
        </c:forEach>
      </tbody>
