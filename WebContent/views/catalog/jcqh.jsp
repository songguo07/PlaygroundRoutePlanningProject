    ...
    <div class="row bottom">
        <div class="col-lg-8 col-md-8 col-sm-7 col-left">
            <div>
                <section>
                    <!--banner image-->
                    <img src="${pageContext.request.contextPath}/views/catalog/img/play/jcqh.jpg" alt="" class="img-responsive">
                    ...
                    <!--project content-->
                    <p class="item-description"><strong>晶彩奇航将借助音乐、灯光和神奇魔法，为游客呈现迪士尼经典故事。</strong></p>
                    <hr>
                    <p><strong>想象力的源泉</strong></p>
                    <p>踏上奇幻世界探索之旅，留下永生难忘的美好回忆。</p>
                    <p><strong>大量迪士尼经典故事</strong></p>
                    <p>再现迪士尼经典故事，激发想象力，鼓舞众人追逐梦想。</p>
                    <!--navigation-->
                    <ul class="pager">
                        <li class="previous"><a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=7&fileName=alsmyxjmg">&lt; 前一个</a></li>
                        <li class="next"><a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=9&fileName=mythsg">后一个 &gt;</a></li>
                    </ul>
                    <hr>
