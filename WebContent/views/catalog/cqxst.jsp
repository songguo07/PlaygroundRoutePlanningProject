...
<head>
    ...
    <link rel="icon" type="${pageContext.request.contextPath}/views/catalog/image/png" href="img/favicon.png">
    ...
    <div class="row bottom">
        <div class="col-lg-8 col-md-8 col-sm-7 col-left">
            <div>
                <section>
                    <!--banner image-->
                    <img src="${pageContext.request.contextPath}/views/catalog/img/play/cqxsw.jpg" alt="" class="img-responsive">
                    ...
                    <!--project content-->
                    <p class="item-description"><strong>在“宝藏湾”主题园区的一艘海盗船残骸中探索戏水，感受互动乐趣。</strong></p>
                    <hr>
                    <p><strong>来探险吧</strong></p>
                    <p>切身体验航海世界的无限乐趣，让孩子的想象力自由驰骋，丰富多彩的活动区域各具特色，各个年龄段的孩子都可以投入其中，尽情嬉戏。</p>
                    <p><strong>告别昔日海盗船，收获更多欢乐！</strong></p>
                    <p>为小海盗一手打造的戏水游乐天堂，小朋友们快来探索吧！</p>
                    <!--navigation-->
                    <ul class="pager">
