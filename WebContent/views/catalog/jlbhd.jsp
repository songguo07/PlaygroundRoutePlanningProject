    ...
    <div class="row bottom">
        <div class="col-lg-8 col-md-8 col-sm-7 col-left">
            <div>
                <section>
                    <!--banner image-->
                    <img src="img/play/jlbhd.jpg" alt="" class="img-responsive">
                    ...
                    <!--project content-->
                    <p class="item-description"><strong>伙计们，来加入杰克船长的海盗队伍，向海洋进发，来一场寻宝之旅，沿途还会遇上怪兽呢！</strong></p>
                    <hr>
                    <p><strong>停下，老伙计</strong></p>
                    <p>和最有魅力的海盗——狡猾而又风度翩翩的杰克船长同行，扬帆宝藏湾！</p>
                    <p>扬帆开启一场乐趣满满的海上之旅，潜入深海，搜寻戴维•琼斯长眠于海底的战利品——沿途还会遇上海盗、美人鱼、甚至还有令人毛骨悚然的的海怪。</p>
                    <p><strong>她出发了……</strong></p>
                    <p>呦-吼呦-吼——封上舱门，和您最爱的加勒比海盗一起来一场前所未有的航行吧！登上这艘以史上最臭名昭著的恶棍命名的航船，亲眼见证他们臭名远扬的故事。</p>
                    <!--navigation-->
                    <ul class="pager">
                        <li class="previous"><a href="cqxst.html">&lt; 前一个</a></li>
                        <li class="next"><a href="tmhyfch.html">后一个 &gt;</a></li>
                    </ul>
                    <hr>
                    ...
                    <!--share-->
                     <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <a id="EvaluateByDId" herf ="GetEvaluateByDId?dId=2">历史评分评价</a>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-right">
                            <!-- <a href="#"><img class="social" src="img/icon/icon-mail.png" alt="Mail"></a>
                            <a href="#"><img class="social" src="img/icon/icon-facebook.png" alt="Facebook"></a>
                            <a href="#"><img class="social" src="img/icon/icon-twitter.png" alt="Twitter"></a>
                            <a hre f="#"><img class="social" src="img/icon/icon-google.png" alt="Google plus"></a>
                            -->
                        </div>
                    </div> 
                </section>
