			...
			<div class="col-lg-4 col-md-4 col-sm-5 col-right">
				...
				<section class="row" id="Grid">
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
						<div class="panel panel-default item">
							<div class="panel-heading">
								<a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=1"> <img class="img-responsive item-img"
									src="img/play/cqxsw.jpg" alt="Work 4">
								</a>
							</div>
							<div class="panel-body">
								<a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=1"><h4 class="item-title">船奇戏水滩</h4></a>
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix excite">
						<div class="panel panel-default item">
							<div class="panel-heading">
								<a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=2"> <img class="img-responsive item-img"
									src="img/play/jlbhd.jpg" alt="Work 5">
								</a>
							</div>
							<div class="panel-body">
								<a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=2"><h4 class="item-title">加勒比海盗-沉落宝藏之战</h4></a>
								<p class="item-category">宝藏湾</p>
					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
						<div class="panel panel-default item">
							<div class="panel-heading">
								<a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=3"> <img class="img-responsive item-img"
									src="img/play/tmhyfch.jpg" alt="Work 6">
								</a>
							</div>
							<div class="panel-body">
								<a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=3"><h4 class="item-title">探秘海妖复仇号</h4></a>
								<p class="item-category">宝藏湾</p>
