    ...
    <div class="row bottom">
                ...
                <section>
                    <div class="row text-center">
                        <div class="col-lg-12">
                            ...
                            <!--activity image-->
                            <img class="img-responsive" src="img/all.jpg" alt="Project header">
        ...
        <div class="col-lg-4 col-md-4 col-sm-5 col-right">
            ...
            <div class="item-choice">
                <a href="#" class="filter" data-filter="all">所有</a>
                <a href="#" class="filter" data-filter="excite">刺激</a>
                <a href="#" class="filter" data-filter="interact">互动</a>
                <a href="#" class="filter" data-filter="happy">欢乐</a>
                <hr>
            </div>
            ...
            <section class="row" id="Grid">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="cqxst.html">
                                <img class="img-responsive item-img" src="img/play/cqxsw.jpg" alt="Work 4">
                            </a>
                        </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix excite">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="jlbhd.html">
                                <img class="img-responsive item-img" src="img/play/jlbhd.jpg" alt="Work 5">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="tmhyfch.html">
                                <img class="img-responsive item-img" src="img/play/tmhyfch.jpg" alt="Work 6">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="txjdmz.html">
                                <img class="img-responsive item-img" src="img/play/txjdmz.jpg" alt="Work 7">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="thgttz.html">
                                <img class="img-responsive item-img" src="img/play/thgttz.jpg" alt="Work 8">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="hdnzjnh.html">
                                <img class="img-responsive item-img" src="img/play/hdnzjnh.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="alsmyxjmg.html">
                                <img class="img-responsive item-img" src="img/play/alsmyxjmg.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="jcqh.html">
                                <img class="img-responsive item-img" src="img/play/jcqh.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="mythsg.html">
                                <img class="img-responsive item-img" src="img/play/mythsg.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix excite">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="qgxarksc.html">
                                <img class="img-responsive item-img" src="img/play/qgxarksc.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="xfxtkqy.html">
                                <img class="img-responsive item-img" src="img/play/xfxtkqy.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="xxwnlxj.html">
                                <img class="img-responsive item-img" src="img/play/xxwnlxj.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="xzfmg.html">
                                <img class="img-responsive item-img" src="img/play/xzfmg.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="ybg.html">
                                <img class="img-responsive item-img" src="img/play/ybg.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="bsgnxjyj.html">
                                <img class="img-responsive item-img" src="img/play/bsgnxjyj.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix excite">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="cjsgl.html">
                                <img class="img-responsive item-img" src="img/play/cjsgl.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="cj.html">
                                <img class="img-responsive item-img" src="img/play/cj.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="pqbbfxq.html">
                                <img class="img-responsive item-img" src="img/play/pqbbfxq.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="tkxhsdq.html">
                                <img class="img-responsive item-img" src="img/play/tkxhsdq.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="hxqxzmm.html">
                                <img class="img-responsive item-img" src="img/play/hxqxzmm.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="mwyxzb.html">
                                <img class="img-responsive item-img" src="img/play/mwyxzb.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="mqjlb.html">
                                <img class="img-responsive item-img" src="img/play/mqjlb.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="xfx.html">
                                <img class="img-responsive item-img" src="img/play/xfx.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="ax.html">
                                <img class="img-responsive item-img" src="img/play/ax.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix happy">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="gjtsy.html">
                                <img class="img-responsive item-img" src="img/play/gjtsy.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix interact">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="hxjyh.html">
                                <img class="img-responsive item-img" src="img/play/hxjyh.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                            <a href="hxjyh.html"><h4 class="item-title">欢笑聚友会</h4></a>
                            <p class="item-category">探险岛</p>
                            <p class="item-description">您在岛上会遇到一些丛林故事里的可爱迪士尼朋友，比如狮子王里的朋友们，甚至可能在现场与疯狂动物城中的朋友们见面！ </p>
                            <hr>
                            <p class="item-tags">
                                <a href="#">室外</a> ,
                                <a href="#">互动项目</a> ,
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6 mix excite">
                    <div class="panel panel-default item">
                        <div class="panel-heading">
                            <a href="lmspl.html">
                                <img class="img-responsive item-img" src="img/play/lmspl.jpg" alt="Work 9">
                            </a>
                        </div>
                        <div class="panel-body">
                            <a href="lmspl.html"><h4 class="item-title">雷鸣山漂流</h4></a>
                            <p class="item-category">探险岛</p>
                            <p class="item-description">踏上刺激的漂筏之旅，深入黑暗的深渊，和凶猛的巨兽赛跑， 在激流中辗转翻腾。</p>
                            <hr>
                            <p class="item-tags">
                                <a href="#">室外</a> ,
                                <a href="#">刺激</a> ,
