    ...
    <div class="row bottom">
        <div class="col-lg-8 col-md-8 col-sm-7 col-left">
            <div>
                <section>
                    <!--banner image-->
                    <img src="${pageContext.request.contextPath}/views/catalog/img/play/hxqxzmm.jpg" alt="" class="img-responsive">
                    ...
                    <!--project content-->
                    <p class="item-description"><strong>乘坐飞马，伴随迪士尼《幻想曲》中恢弘大气的交响乐，回旋在梦幻的世界里。</strong></p>
                    <hr>
                    <p><strong>花园景致</strong></p>
                    <p>沉醉于迪士尼的艺术之美：精心修剪的树木，尽情绽放的繁花，一派生机盎然的景象。</p>
                    <p><strong>灵感来源</strong></p>
                    <p>仿佛宙斯、酒神巴克斯和众多神话人物冥冥之中召唤您进入奇幻世界，让想象力任意驰骋。</p>
                    <p><strong>迪士尼旋转木马</strong></p>
                    <p>属于您的飞马静候您的到来，坐上飞马纵情驰骋梦幻间，体验迪士尼乐园史上最奇妙的旋转。</p>
                    <!--navigation-->
                    <ul class="pager">
                        <li class="previous"><a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=19&fileName=tkxhsdq">&lt; 前一个</a></li>
                        <li class="next"><a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=21&fileName=mwyxzb">后一个 &gt;</a></li>
                    </ul>
                    <hr>
