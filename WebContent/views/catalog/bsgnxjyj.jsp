    ...
    <div class="row bottom">
        <div class="col-lg-8 col-md-8 col-sm-7 col-left">
            <div>
                <section>
                    <!--banner image-->
                    <img src="${pageContext.request.contextPath}/views/catalog/img/play/bsgnxjyj.jpg" alt="" class="img-responsive">
                    ...
                    <!--project content-->
                    <p class="item-description"><strong>投身战斗，竭尽全力消灭索克天王手下骇人的机器人部队，拯救外星人的星球！</strong></p>
                    <hr>
                    <p><strong>伽玛象限需要您</strong></p>
                    <p>从默默无闻到太空骑警大英雄——加入互动，踏上星际探险之旅，和巴斯光年一起阻止星际指挥部的头号要犯！</p>
                    <p>索克天王已经回来，带着用水晶提供能量的巨型超能炮，妄图摧毁外星人的星球，掀起宇宙大混乱。</p>
                    <p><strong>服务和保护</strong></p>
                    <p>跟随使命召唤，瞄准射击——外星人家园的命运就在您手中。</p>
                    <p><strong>轰炸大荧幕</strong></p>
                    <p>安迪的超级巨星太空骑警成为了全新征程的主角，超越了星系的界限。</p>
                    <!--navigation-->
                    <ul class="pager">
                        <li class="previous"><a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=14&fileName=ybg">&lt; 前一个</a></li>
                        <li class="next"><a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=16&fileName=cjsgl">后一个 &gt;</a></li>
                    </ul>
                    <hr>
