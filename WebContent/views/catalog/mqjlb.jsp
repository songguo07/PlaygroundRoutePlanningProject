    ...
    <div class="row bottom">
        <div class="col-lg-8 col-md-8 col-sm-7 col-left">
            <div>
                <section>
                    <!--banner image-->
                    <img src="${pageContext.request.contextPath}/views/catalog/img/play/mqjlb.jpg" alt="" class="img-responsive">
                    ...
                    <!--project content-->
                    <p class="item-description"><strong>准备好您的镜头！在与举世闻名的米奇会面之前，参观一个魔法画展吧！ </strong></p>
                    <hr>
                    <p><strong>愉快的会面和问候</strong></p>
                    <p>为VIM——非常重要的老鼠——铺上红毯，这次迪士尼朋友问候体验将让您永生难忘。</p>
                    <p><strong>一切都从一只老鼠开始</strong></p>
                    <p>从《威力汽船》到史上最广为人知的卡通角色，米奇是迪士尼魔法的标志性代表，1928年，华特•迪士尼向世界介绍了这只小老鼠，从此一代又一代的人们为他着迷。</p>
                    <!--navigation-->
                    <ul class="pager">
                        <li class="previous"><a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=21&fileName=mwyxzb">&lt; 前一个</a></li>
                        <li class="next"><a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=23&fileName=xfx">后一个 &gt;</a></li>
                    </ul>
                    <hr>
