    ...
    <div class="row bottom">
        <div class="col-lg-8 col-md-8 col-sm-7 col-left">
            <div>
                <section>
                    <!--banner image-->
                    <img src="${pageContext.request.contextPath}/views/catalog/img/play/xzfmg.jpg" alt="" class="img-responsive">
                    ...
                    <!--project content-->
                    <p class="item-description"><strong>与同伴一起乘坐旋转疯蜜罐，在自由控制的旋转中体验寻找美味的乐趣。小熊维尼和他的伙伴在等着你！</strong></p>
                    <hr>
                    <p><strong>寻找美味的冒险</strong></p>
                    <p>前往“百亩森林”，在回旋中体验无限欢乐，属于您的疯蜜罐在等着您！和屹耳、瑞比、猫头鹰、小猪、袋鼠妈妈和小豆一起帮助克里斯多夫·罗宾亲爱的“小笨熊”找到最爱的美食。 </p>
                    <p><strong>疯帽子旋转杯摇身变为旋转疯蜜罐</strong></p>
                    <p>旋转疯蜜罐是一处阖家同乐的理想选择，受其他迪士尼主题乐园“疯狂茶会派对”景点的启发。</p>
                    <!--navigation-->
                    <ul class="pager">
                        <li class="previous"><a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=12&fileName=xxwnlxj">&lt; 前一个</a></li>
                        <li class="next"><a href="${pageContext.request.contextPath}/GetEvaluateByDId?dId=14&fileName=ybg">后一个 &gt;</a></li>
                    </ul>
                    <hr>
<div class="col-lg-8 col-md-8 col-sm-7 col-left">
								<section>
