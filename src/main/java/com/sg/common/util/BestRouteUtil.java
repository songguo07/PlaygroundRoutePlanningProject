...
public class BestRouteUtil {
	...
	public static int playtime[] = { 15, 5, 5, 5, 5, 10, 15, 10, 5, 10, 10, 10, 5, 5, 10, 5, 5, 5, 5, 5, 10, 10, 18, 20, 30, 30 };

	public static String name[] = { "爱丽丝梦游仙境迷宫", "翱翔-飞越地平线", "巴斯光年星际营救", "米奇俱乐部", "创极速光轮-雪佛兰呈献", "弹簧狗团团转", "古迹探索营", "欢笑聚友会",
		...
		if(weight!=null) {
			for(int i=0;i<name.length;i++) {
				for (String wei : weight) {
					if(wei.equals(name[i])) pre[i]=-10000;
				}
			}
		}
